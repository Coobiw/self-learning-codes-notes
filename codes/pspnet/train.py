...
@click.option('--models-path', type=str, default='./models/', help='Path for storing model snapshots')
...
@click.option('--alpha', type=float, default=0., help='Coefficient for classification loss term')
...
@click.option('--milestones', type=str, default='10,20,30,40', help='Milestones for LR decreasing')
...
def train(models_path, backend, snapshot, batch_size, alpha, epochs, start_lr, milestones, gpu,workers):
    ...
    '''
    train_loader = DataLoader(TRAINSET,batch_size,shuffle=True,num_workers=workers)
